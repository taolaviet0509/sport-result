...
export const GermanyFlag = ({ height = '24rem', width = '32rem', className }) => (
    <img
        className={className}
        width={width}
        height={height}
        viewBox="0 0 32 32"
        src="https://www.betexplorer.com/res/images/flags/4x3/de.svg"
        alt="Germany-flag"
    ></img>
);

export const EnglandFlag = ({ height = '24rem', width = '32rem', className }) => (
    <img
        className={className}
        width={width}
        height={height}
        viewBox="0 0 32 32"
        src="https://www.betexplorer.com/res/images/flags/4x3/198.svg"
        alt="England-flag"
    ></img>
);

export const SpainFlag = ({ height = '24rem', width = '32rem', className }) => (
    <img
        className={className}
        width={width}
        height={height}
        viewBox="0 0 32 32"
        src="https://www.betexplorer.com/res/images/flags/4x3/es.svg"
        alt="Spain-flag"
    ></img>
);
export const ItalyFlag = ({ height = '24rem', width = '32rem', className }) => (
    <img
        className={className}
        width={width}
        height={height}
        viewBox="0 0 32 32"
        src="https://www.betexplorer.com/res/images/flags/4x3/it.svg"
        alt="Italy-flag"
    ></img>
);

export const FranceFlag = ({ height = '24rem', width = '32rem', className }) => (
    <img
        className={className}
        width={width}
        height={height}
        viewBox="0 0 32 32"
        src="https://www.betexplorer.com/res/images/flags/4x3/fr.svg"
        alt="France-flag"
    ></img>
);

export const NertherlandsFlag = ({ height = '24rem', width = '32rem', className }) => (
    <img
        className={className}
        width={width}
        height={height}
        viewBox="0 0 32 32"
        src="https://www.betexplorer.com/res/images/flags/4x3/nl.svg"
        alt="Nertherlands-flag"
    ></img>
);

export const PortugalFlag = ({ height = '24rem', width = '32rem', className }) => (
    <img
        className={className}
        width={width}
        height={height}
        viewBox="0 0 32 32"
        src="https://www.betexplorer.com/res/images/flags/4x3/pt.svg"
        alt="Portugal-flag"
    ></img>
);

export const TurkeyFlag = ({ height = '24rem', width = '32rem', className }) => (
    <img
        className={className}
        width={width}
        height={height}
        viewBox="0 0 32 32"
        src="https://www.betexplorer.com/res/images/flags/4x3/tr.svg"
        alt="Turkey-flag"
    ></img>
);

export const BelgiumFlag = ({ height = '24rem', width = '32rem', className }) => (
    <img
        className={className}
        width={width}
        height={height}
        viewBox="0 0 32 32"
        src="https://www.betexplorer.com/res/images/flags/4x3/be.svg"
        alt="Belgium-flag"
    ></img>
);
